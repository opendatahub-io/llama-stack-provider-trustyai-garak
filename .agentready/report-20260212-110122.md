...
**Path**: `/Users/ddahlem/Documents/repos/trusty/opendatahub-io/llama-stack-provider-trustyai-garak`
**Branch**: `main` | **Commit**: `9dcbac79`
...
| Metric | Value |
|--------|-------|
| **Overall Score** | **54.6/100** 🥉 **Bronze** ([Tier Definitions](https://agentready.dev/attributes.html#tier-system)) |
...
![T1](https://img.shields.io/badge/T1-Type_Annotations_36--100-red) **Type Annotations** ❌ 36/100
<details>
<summary>📝 Remediation Steps</summary>

**Measured**: 28.8% (Threshold: ≥80%)

**Evidence**:
- Typed functions: 44/153
- Coverage: 28.8%
...
![T2](https://img.shields.io/badge/T2-Separation_of_Concerns_86--100-green) **Separation of Concerns** ✅ 86/100
...
**Evidence**:
- CI config found: .github/workflows/security.yml, .github/workflows/run-tests.yml, .github/workflows/tests.yml, .github/workflows/agentready-assessment.yml, .github/workflows/sync-branch-incubation.yaml, .github/workflows/build-and-publish.yaml, .github/workflows/sync-branch-stable.yaml
...
- **Repository Snapshot**: 9dcbac7914ef13199cad02013ebcaac725f5efca
- **Assessment Duration**: 0.4s
